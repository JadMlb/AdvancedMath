...
public class Graph2D_old
{
	 ...
	 * @param xStep
	 * 
	 * @see Graph2D_old#Graph2D(String)
	 * @see Graph2D_old#Graph2D(String, Range)
	 * @see Graph2D_old#Graph2D(String, String[], Range)
	 */
	public Graph2D_old (String title, Range graphRange, String[] axesNames, double xStep) 
	{
		if (graphRange == null)
	...
	public Graph2D_old (String title)
	{
		this (title, null, null, 0);
	}

	public Graph2D_old (String title, Range graphRange)
	{
		this (title, graphRange, null, 0);
	}

	public Graph2D_old (String title, String[] axesNames, Range graphRange)
	{
			...
			new EventHandler<MouseEvent> ()
			{
				...
				public void handle (MouseEvent e)
				{
					...
					for (Function f : fnPoints.keySet())
					{
						...
						for (Value i = start; i.compareTo (stop) == -1; i = i.add (new FloatValue (xStep)))
						{
							Number x = Number.real (i);
							HashMap<String, Number> values = new HashMap<>();
